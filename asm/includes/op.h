...
void					syntax_error_separator(char *start,
						char *line, int line_number);
void					syntax_error(char *start, char *line,
						int line_number, char *type);
void					syntax_error_string(char *start, char *line,
						int line_number);
void					syntax_error_double_command(int size,
						char *start, char *line, int line_number);
...
void					check_end_arg_line(t_arg_error *err,
						t_command *c_temp, t_asm *ass);
void					check_begin_arg_line(t_arg_error *err,
						t_command *c_temp, t_asm *ass);
void					push_command(t_asm *ass, t_command *c_temp,
						int index, char *line);
